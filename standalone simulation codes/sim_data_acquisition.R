...
Simulate_data = function(n, p, model, censoring_rate, rho, bin_prob = 0.5,
  ...
  # Updating p by the column number of B to accommodate the case of just.first100 = TRUE
  p0 = dim(B)[2]
